...
import com.baloise.open.devops.monitor.client.infrastructure.kafka.mapper.EventToAvroMapper;
...
public class EventProducerTest {
    ...
    public void testSend() {
        ...
        //given
        com.baloise.open.devops.monitor.client.domain.model.Event event = TestModelFactory.createDefault();
